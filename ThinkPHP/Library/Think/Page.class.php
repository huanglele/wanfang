...
class Page{
    ...
    private $config  = array(
        'header' => '<li class="rows"><a>共 %TOTAL_ROW% 条</a></li>',
        'prev'   => '上一页',
        'next'   => '下一页',
        'first'  => '首页',
        'last'   => '末页',
//        'theme'  => '%HEADER% %FIRST% %UP_PAGE% %LINK_PAGE% %DOWN_PAGE% %END%',
        'theme'  => '%FIRST% %UP_PAGE%  %DOWN_PAGE% %END%',
    );
    ...
    public function show() {
        ...
        for($i = 1; $i <= $this->rollPage; $i++){
            ...
            if($page > 0 && $page != $this->nowPage){
                ...
                if($page > 0 && $this->totalPages != 1){
                    $link_page .= '<li class="mui-disabled"><a>' . $page . '</a></li>';
                }
            }
        }
        ...
        $page_str = str_replace(
            ...
            $this->config['theme']);
        return "<ul class='mui-pager'>{$page_str}</ul>";
    }
}
